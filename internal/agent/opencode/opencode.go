...
func discoverFromSQLite(dataDir, projectID, projectPath string) (*agent.SessionInfo, error) {
	...
	// OpenCode 1.x uses updated_at (Unix ms integer) as the timestamp column.
	...
	// updated_at is stored as Unix milliseconds (integer) in OpenCode 1.x.
	...
	if err == nil {
		...
		// Try Unix milliseconds first (OpenCode 1.x stores timestamps as INTEGER ms)
	...
	// created_at is the ordering column in OpenCode 1.x.
