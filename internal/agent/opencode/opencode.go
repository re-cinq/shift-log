...
// OpenCode (v1.2+) stores timestamps as JSON objects in a "time" column:
//   - session.time = {"created":"<iso>","updated":"<iso>"}
//   - message.time = {"created":"<iso>"}
func discoverFromSQLite(dataDir, projectID, projectPath string) (*agent.SessionInfo, error) {
	...
	// The "time" column is a JSON object: {"created":"...","updated":"..."}
	...
	// The "time" column on message is a JSON object: {"created":"..."}
