...
func discoverFromSQLite(dataDir, projectID, projectPath string) (*agent.SessionInfo, error) {
	...
	// Try multiple column/field names to handle schema variations across versions.
	timeQueries := []string{
	...
	for _, tq := range timeQueries {
		...
		// If we can't parse the time string, proceed — better to try than skip
	}

	// Get messages for this session as a JSON array.
	// Use json(data) to ensure proper JSON typing regardless of storage format.
	// Order by rowid for insertion order — time_created column may not exist in all versions.
