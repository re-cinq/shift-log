...
// OpenCode stores timestamps as JSON objects {"created":"...","updated":"..."} in a
// 'time' column, so we use json_extract() to access the nested fields.
func discoverFromSQLite(dataDir, projectID, projectPath string) (*agent.SessionInfo, error) {
	...
	// opencode stores time as a JSON object in the 'time' column: {"created":"...","updated":"..."}
	...
	// opencode stores message time as JSON in the 'time' column too.
