...
func discoverFromSQLite(dataDir, projectID, projectPath string) (*agent.SessionInfo, error) {
	...
	// Use rowid for ordering to avoid dependency on column names that may vary
	// across opencode versions (time_updated vs updated vs updatedAt).
	...
	// Try multiple column name variants used across opencode versions.
...
// isSessionRecent checks whether a session was updated recently enough to be considered active.
// It tries multiple column name variants to handle different opencode schema versions.
func isSessionRecent(dbPath, sessionID string) bool {
	// Try column names used across different opencode versions
	timeColumns := []string{"time_updated", "updated", "updatedAt", "time_created", "created"}
