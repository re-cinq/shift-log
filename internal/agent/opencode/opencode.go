...
// (pre-v1.17 used time_updated/time_created; v1.17+ may use a JSON time blob or rowid ordering).
func discoverFromSQLite(dataDir, projectID, projectPath string) (*agent.SessionInfo, error) {
	...
	// Try multiple column expressions for compatibility.
	for _, col := range []string{"time_updated", "json_extract(time, '$.updated')"} {
