...
//
// Note: We do not call client.session.messages() — that SDK call can hang
// indefinitely in some OpenCode versions. shiftlog reads the transcript directly
// from .opencode/opencode.db at store time instead.
