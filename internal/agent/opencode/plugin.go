...
// Transcript data is read directly from SQLite by the shiftlog Go binary using
// data_dir and session_id, so the plugin does not call any client API that may block.
