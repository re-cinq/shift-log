...
//
// The client.session.messages() call uses a 5-second timeout to prevent blocking
// OpenCode's tool execution pipeline if the SDK method hangs (observed in v1.17+).
...
export const ShiftlogPlugin = async ({ directory, client }) => {
  ...
  return {
    ...
    "tool.execute.after": async (input, output) => {
      ...
      // The timeout prevents blocking OpenCode if the client method hangs.
      let transcriptData = "";
