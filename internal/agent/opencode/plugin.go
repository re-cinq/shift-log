...
//
// Note: The client.session.messages() SDK API is intentionally not used here
// because it hangs in OpenCode v1.17+. Transcript data is retrieved by
// shiftlog directly from the project-local SQLite database.
