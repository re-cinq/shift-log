...
//
// client.session.messages() is called with a 5-second timeout via Promise.race to
// guard against API changes in newer OpenCode versions where the call may hang.
